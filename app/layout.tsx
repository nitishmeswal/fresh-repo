        ...
        <div className="px-4 md:px-8 h-20 flex items-center justify-between relative">
          ...
          <div className="flex items-center space-x-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" sideOffset={8} className="min-w-fit p-1 bg-black/90 backdrop-blur-xl border border-white/10 z-[50]">
                <DropdownMenuItem 
                  className="flex items-center justify-center p-1 text-gray-300 hover:text-white focus:text-white cursor-pointer"
                ...
                >
                  <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1024 1024">
